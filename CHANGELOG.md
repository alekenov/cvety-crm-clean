...
#### Добавлено
- Новые типы фильтров:
  - Фильтр диапазона дат с календарем
  - Фильтр числовых диапазонов с поддержкой префиксов и суффиксов
  - Фильтр с выпадающим списком
- Поддержка мультивыбора фильтров:
  - Shift + клик для выбора диапазона
  - Ctrl/Cmd + клик для добавления/удаления отдельных фильтров
  - Визуальная индикация режима мультивыбора

#### Улучшено
- Сохранение состояния фильтров в URL и localStorage
- Улучшена доступность компонентов с ARIA-атрибутами
- Добавлена поддержка русской локализации для дат
- Оптимизирована производительность с помощью мемоизации

#### Технические детали
- Создана новая директория `features/filters` для компонентов фильтрации
- Добавлены PropTypes для валидации входных данных
- Улучшена типизация компонентов
- Добавлены анимации для улучшения UX

## 2024-11-24
### Исправление компонента Select

#### Исправлено
- Исправлен баг с неработающим компонентом Select в OrdersPage
- Оптимизированы экспорты компонентов Select в select.jsx
- Удален лишний wrapper SelectPrimitive.Viewport для улучшения производительности
